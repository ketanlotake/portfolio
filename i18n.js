...
(function () {
  ...
  const japanese = {
    ...
    impactBodyHtml:
      'ベンダーの提案ではなく自社で設計することで、運用・開発・ライセンスの費用を下げ、5年間で約<span class="metric">5億円</span>を削減しました。さらにテストの自動化で年間<span class="metric">1,800万円</span>を減らし、古いサービスをマイクロサービス、DevOps、クラウドで新しくして、処理できる量を増やしました。',
    deliveryTitle: "デリバリー",
    deliveryBody:
    ...
    proj2Body:
      "AzureのIaaSをPaaSに移行し、Azure Cosmos DBを導入しました。クラウドネイティブの技術とアジャイル開発を使い、長く使える拡張性と安定した運用を目指して、デジタル変革を進めました。",
    proj3Meta: "2018年 - 2022年 | エンジニア",
    proj3Title: "モノリスからマイクロサービスへの刷新",
    proj3Body:
      "古いモノリシックなシステムをコンテナのサービスに作り直し、主要な機能に影響を与えずに、DevOpsのやり方で拡張性を大きく高め、リリース能力を強化しました。",
    proj4Meta: "2020年 - 2021年 | エンジニア",
    proj4Title: "［モノリシック］入出金明細レポートの全期間対応",
    proj4BodyHtml:
      '今あるモノリシックな基盤に新しいサービスを追加して、入出金明細レポートを全期間に対応させ、レポートの連続性と運用の信頼性を高めました。ベンダーの提案よりシンプルな自社の設計にして、運用・開発・ライセンスの費用を含めて<span class="metric">5年間で約5億円</span>を削減しました。',
    proj5Meta: "2019年 - 2020年 | エンジニア",
    proj5Title: "回帰テストの自動化フレームワーク",
    proj5BodyHtml:
      '回帰テストの自動化フレームワークを設計・開発し、運用の費用を年間で約<span class="metric">1,800万円</span>減らしました。',
